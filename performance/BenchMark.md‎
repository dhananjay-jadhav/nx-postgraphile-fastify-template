...
## 🔥 Stress Test Results (80 connections, 60s)

### REST API Performance

| Endpoint | Express (req/s) | Fastify (req/s) | **Improvement** | Fastify Latency | Fastify P99 |
|----------|-----------------|-----------------|-----------------|-----------------|-------------|
| `/live` | 8,844 | **16,766** | **+90%** 🚀 | 4.28ms | 14ms |
| `/api` | 7,000 | **13,911** | **+99%** 🚀 | 5.26ms | 20ms |
...
|-------|-----------------|-------------|-------------|------------|
| **User by ID** ⭐ | **7,632** | 10.0ms | 49ms | 5.82 MB/s |
...
| Finding | Details |
|---------|---------|
| ✅ **Fastify wins for pure HTTP** | 90-99% improvement for `/live` and `/api` |
| ✅ **Indexed queries are fastest** | `userById` achieves 7,632 req/s with 49ms P99 |
| ✅ **GraphQL scales well** | 5,000-7,600 req/s for various query types |
| ⚠️ **Mutations are I/O bound** | Create: 1,268 req/s (disk writes + triggers) |
| ⚠️ **Complex queries have higher P99** | Pagination: 240ms P99 under load |
